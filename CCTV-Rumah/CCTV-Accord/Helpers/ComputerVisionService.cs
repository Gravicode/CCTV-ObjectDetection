...
namespace CCTV_Accord
{
    public class ComputerVisionService
    {
        ...
        public async Task<string> RecognizeText(string imageFile)
        {
        ...
        public async Task<string> RecognizeImage(string imageFile)
        {  
        ...
        private async Task<AnalysisResult> UploadAndAnalyzeImage(string imageFile)
        {
            var stream = new FileStream(imageFile, FileMode.Open);//await imageFile.OpenStreamForReadAsync();
        ...
        private async Task<OcrResults> UploadAndRecognizeImage(string imageFile, string language)
        {
            var stream = new FileStream(imageFile, FileMode.Open);//await imageFile.OpenStreamForReadAsync();
